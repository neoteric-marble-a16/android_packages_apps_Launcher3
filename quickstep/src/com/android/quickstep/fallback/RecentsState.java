...
public class RecentsState implements BaseState<RecentsState> {
    ...
    private static final int FLAG_DETACH_DESKTOP_CAROUSEL = BaseState.getFlag(10);
    private static final int FLAG_ADD_DESK_BUTTON = BaseState.getFlag(11);
    private static final int FLAG_SHOW_EXPLODED_DESKTOP_VIEW = BaseState.getFlag(12);
